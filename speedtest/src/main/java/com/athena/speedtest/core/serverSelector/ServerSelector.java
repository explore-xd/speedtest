package com.athena.speedtest.core.serverSelector;
...
public abstract class ServerSelector {
    ...
    private void next() {
        ...
        synchronized (mutex) {
            ...
            PingStream ps = new PingStream(tp.getServer(), tp.getPingURL(), PINGS, SpeedTestConfig.ONERROR_FAIL, timeout, timeout, -1, -1, null, tp.getAuthorization()) {
                @Override
